...
try {
    ...
    if ($check->num_rows > 0){
        echo json_encode(array("statusCode" => 201, "message" => "ຫ້ອງພັກນີ້ເຄີຍຖືກຈອງແລ້ວໃນວັນ $startDate ຫາ $endDate ກະລຸນາລອງໃໝ່"), JSON_UNESCAPED_UNICODE);
    }else{

        $sql = "INSERT INTO booking SET customer_id='$customer', room_id='$room',start_date='$startDate', end_date='$endDate',employee_id=1";
