...
<!-- Bootstrap Select -->
<link rel="stylesheet" href="<?= $path ?>assets/plugins/bootstrap-select/dist/css/bootstrap-select.min.css">
<!-- Bootstrap table -->
<link rel="stylesheet" href="<?= $path ?>assets/plugins/bootstrap-table/dist/bootstrap-table.min.css">
<!-- overlayScrollbars -->
