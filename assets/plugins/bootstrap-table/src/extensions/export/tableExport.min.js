...
(function(d) {
    d.fn.tableExport = function(k) {
        ...
        function v(b, a) { var c = b[0].tagName,
                p = b.parents(c).length; return b.find(a).filter(function() { return p === d(this).closest(c).parents(c).length }) }

        function R(b) { var a = [],
                e = 0,
                p = 0,
                f = 0;
            d(b).find("thead").first().find("th").each(function(b, c) { b = void 0 !== d(c).attr("data-field"); "undefined" !== typeof c.parentNode.rowIndex && p !== c.parentNode.rowIndex && (p = c.parentNode.rowIndex, e = f = 0); var l = J(c); for (e += l ? l : 1; f < e;) a[f] = b ? d(c).attr("data-field") : f.toString(), f++ }); return a }
        ...
        function ta(b, c, e) { var p = !1;
            I(b) ? 0 < a.ignoreColumn.length && (-1 !== d.inArray(e, a.ignoreColumn) || -1 !== d.inArray(e - c, a.ignoreColumn) || S.length > e && "undefined" !== typeof S[e] && -1 !== d.inArray(S[e], a.ignoreColumn)) && (p = !0) : p = !0; return p }
            ...
            if ("function" === typeof f) {
                ...
                if (!1 === l &&
                    ...
                    b.each(function() { var b = d(this),
                            ...
                            c = T(this),
                            l;
                        d.each(G, function() { if (e > this.s.r && e <= this.e.r && h >= this.s.c && h <= this.e.c)
                                for (l = 0; l <= this.e.c - this.s.c; ++l) q++, u++, f(null, e, h++) }); if (c || a) a = a || 1, G.push({ s: { r: e, c: h }, e: { r: e + (c || 1) - 1, c: h + a - 1 } });!1 === ta(b, q, u++) && f(this, e, h++); if (1 < a)
        ...
        function va(b, c) { if ("string" === a.outputMode) return b.output(); if ("base64" === a.outputMode) return L(b.output()); if ("window" === a.outputMode) window.URL = window.URL || window.webkitURL, window.open(window.URL.createObjectURL(b.output("blob")));
                ...
                saveAs(e, a.fileName + ".pdf") } catch (p) { ka(a.fileName + ".pdf", "data:application/pdf" + (c ? "" : ";base64") + ",", c ? b.output("blob") : b.output()) } }
                    ...
                    if (b.src) {
                        ...
                        c.onerror = c.onload = function() {
                            if (c.complete &&
                                ...
                                e.height = c.height;
                                d.drawImage(c, 0, 0);
                                b.src = e.toDataURL("image/png") }--f || a(p)
                        };
                        c.src = b.url
                    } else { var e = d(b.url);
        ...
        function za(b, c, e) {
            c.each(function() {
                if (d(this).is("div")) { var c = ea(M(this, "background-color"), [255, 255, 255]),
                    ...
                    e.doc.rect(b.x + h, b.y + u, g, q, l ? "FD" : "F") } else d(this).is("img") &&
            ...
            if (null !== b) {
                ...
                if (q[0].hasAttribute("data-tableexport-canvas")) var h = "";
                    ...
                    d.each(b, function() {
                        ...
                        else { if ("undefined" === typeof d(this).html()) h += d(this).text();
                            else if (void 0 === jQuery().bootstrapTable || !1 === d(this).hasClass("fht-cell") && !1 === d(this).hasClass("filterControl") && 0 === q.parents(".detail-view").length) h += d(this).html(); if (d(this).is("a")) { var b = q.find("a").attr("href") || "";
                ...
                if (h && "" !==
                    ...
                    if ("" !== q.attr("data-tableexport-cellformat")) {
                        ...
                        b = !1;
                        m = "";
                        d.each(n.text().split("\u2028"), function(b, c) { 0 < b && (m += " ");!0 !== a.preserve.leadingWS && (c = la(c));
        ...
        function ya(a) { var b = 0,
                d; if (0 === a.length) return b; var p = 0; for (d = a.length; p < d; p++) { var f = a.charCodeAt(p);
                b = (b << 5) - b + f;
                b |= 0 } return b }
        ...
        function L(a) {
            var b, d = "",
                p = 0;
            if ("string" ===
                typeof a) { a = a.replace(/\x0d\x0a/g, "\n"); var f = ""; for (b = 0; b < a.length; b++) { var l = a.charCodeAt(b);
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            w = C(d(B));
            d(w).each(function() { t = "";
                E(this, "td,th", n, r.length + w.length, function(a, c, d) { a = D(a, c, d) || ""; - 1 < a.indexOf("'") && (a = V(a.toString(), "'", "''"));
                    t += "'" + a + "'," });
            ...
            d(w).each(function() { var a = {},
                    c = 0;
                E(this, "td,th", n, r.length + w.length, function(b, d, f) { W.length ? a[W[W.length - 1][c]] = D(b, d, f) : a[c] = D(b, d, f);
            ...
            Q += "<tabledata><fields>";
            r = y(d(B));
            d(r).each(function() { E(this, "th,td", n, r.length, function(a, d, e) { Q += "<field>" + D(a, d, e) + "</field>" });
                n++ });
            Q += "</fields><data>";
            var Fa =
                1;
            ...
            d(w).each(function() { var a = 1;
                t = "";
                E(this, "td,th", n, r.length + w.length, function(b, d, g) { t += "<column-" + a + ">" + D(b, d, g) + "</column-" + a + ">";
                    a++ });
                    ...
                    d(a).each(function() {
                        ...
                        E(this, "td,th", n, c + a.length, function(a, c, l) {
                            if (null !== a) {
                                ...
                                g = J(a);
                                a = T(a);
                                d.each(e, function() { if (n >= this.s.r && n <= this.e.r && f >= this.s.c && f <= this.e.c)
                        ...
                        for (k = m = 0; k < y.length; ++k)
                            if (r = y[k], t = +J(r) || 1, l = k + z, !ta(d(r), B, l + (l < m ? m - l : 0))) {
                                ...
                                for (l = 0; l < f.length; ++l) { var v = f[l];
                                    v.s.c == m && v.s.r <= u && u <= v.e.r && (m = v.e.c + 1, l = -1) }(0 < (n = +T(r)) || 1 < t) && f.push({ s: { r: u, c: m }, e: { r: u + (n || 1) - 1, c: m + t - 1 } });
                                var C = { type: "" };
                                l = D(r, h, k + z, C);
                                v = { t: "s", v: l };
                                var A = "";
                    ...
                    var g = function(a, b, c) {
                        ...
                        d(a).each(function() {
                            ...
                            E(this, b, n, c, function(b,
                                d, c) { if ("undefined" !== typeof b && null !== b) { var f = J(b),
                                        e = T(b);
                                    b = D(b, d, c) || " ";
                                    1 < f || 1 < e ? a.push({ colSpan: f || 1, rowSpan: e || 1, text: b }) : a.push(b) } else a.push(" ") });
                            a.length && e.push(a);
            ...
            } else if (!1 === a.jspdf.autotable) { k = { dim: { w: fa(d(B).first().get(0), "width", "mm"), h: fa(d(B).first().get(0), "height", "mm") }, pagesplit: !1 }; var Ha = new jsPDF(a.jspdf.orientation, a.jspdf.unit, a.jspdf.format);
            ...
            if ("string" === typeof a.jspdf.format && "bestfit" === a.jspdf.format.toLowerCase()) {
                ...
                d(B).each(function() {
                    if (I(d(this))) {
                        ...
                        if (a > Ia) { a > O.a0[0] && (ja = "a0", ca = "l"); for (var c in O) O.hasOwnProperty(c) && O[c][1] > a && (ja = c, ca = "l", O[c][0] > a && (ca = "p"));
                            Ia = a }
                    }
                });
                ...
                d(B).filter(function() { return I(d(this)) }).each(function() {
                    ...
                    d(r).each(function() {
                        b =
                            0;
                        g.headerrows[n] = [];
                        E(this, "th,td", n, r.length, function(a, c, d) { var e = Ca(a);
                            e.title = D(a, c, d);
                            e.key = b++;
                            e.rowIndex = n;
                    ...
                    if (0 < n)
                        for (var e = n - 1; 0 <= e;) d.each(g.headerrows[e], function() { var a = this;
