                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="table" class="table data-table" data-classes="table table-hover table-striped" data-search="true" data-pagination="true" data-toggle="table" data-id-field="id" data-toolbar=".toolbar" data-search-highlight="true" data-click-to-select="true" data-url="http://localhost/laksaohotel/api/admin/room_type/fetch">
                                        <thead>
        ...
        $(document).ready(function() {
            ...
            $('#add_form').on('submit', function(e) {
                ...
                if ($type_name != null && ($price != null || $price == 0)) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/room_type/insert',
                        type: 'post',
                        data: {
                            'type_name': $type_name,
                            'price': $price,
            ...
            $('#edit_form').on('submit', function(e) {
                ...
                if (updateId != null) {
                    ...
                    if ($type_name != '' && ($price != '' || $price != 0)) {
                        $.ajax({
                            url: 'http://localhost/laksaohotel/api/admin/room_type/update',
                            type: 'post',
                            data: {
                                'action': 'update',
                                'id': updateId,
        ...
        function checkDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/room_type/delete',
                        type: 'post',
                        data: {
                            'id': id,
                        },
