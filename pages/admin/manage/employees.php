                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="table" class="table data-table" data-classes="table table-hover table-striped" data-search="true" data-pagination="true" data-toggle="table" data-id-field="id" data-toolbar=".toolbar" data-search-highlight="true" data-click-to-select="true" data-url="http://localhost/laksaohotel/api/admin/employee/fetch">
        ...
        $(document).ready(function() {
            ...
            $('#add_form').on('submit', function(e) {
                ...
                if ($code != null && $name != null && $gender != null && $username != null && $password != null) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/employee/insert',
                        type: 'post',
                        data: {
                            'code': $code,
                            'name': $name,
            ...
            $('#edit_form').on('submit', function(e) {
                ...
                if (updateId != null) {
                    ...
                    if ($code != '' && $name != '' && $gender != '' && $username != '') {
                        $.ajax({
                            url: 'http://localhost/laksaohotel/api/admin/employee/update',
                            type: 'post',
                            data: {
                                'action': 'update',
                                'id': updateId,
        ...
        function checkDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/employee/delete',
                        type: 'post',
                        data: {
                            'id': id,
                        },
