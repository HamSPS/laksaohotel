...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="table" class="table data-table" data-classes="table table-hover table-striped" data-search="true" data-pagination="true" data-toggle="table" data-id-field="id" data-toolbar=".toolbar" data-search-highlight="true" data-click-to-select="true" data-url="http://localhost/laksaohotel/api/admin/room/fetch">
                                        <thead>
    ...
    <script>
        $(document).ready(function() {
            ...
            function load_type() {
                $.ajax({
                    url: 'http://localhost/laksaohotel/api/admin/room/find_type',
                    dataType: 'json',
            ...
            $('#add_form').on('submit', function(e) {
                ...
                if ($room_no != null && $type_id != null) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/room/insert',
                        type: 'post',
                        data: {
                            'room_no': $room_no,
                            'type_id': $type_id,
            ...
            $('#edit_form').on('submit', function(e) {
                ...
                if (updateId != null) {
                    ...
                    if ($room_no != '' && $type_id != '') {
                        $.ajax({
                            url: 'http://localhost/laksaohotel/api/admin/room/update',
                            type: 'post',
                            data: {
                                'action': 'update',
                                'id': updateId,
        ...
        function checkDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/room/delete',
                        type: 'post',
                        data: {
                            'id': id,
                        },
