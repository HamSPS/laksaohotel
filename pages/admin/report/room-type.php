...
session_start();
$path = '../../../';
$title = "ລາຍງານຂໍ້ມູນປະເພດຫ້ອງພັກ";
$IsActive = 10;
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <table id="table" class="table" data-classes="table table-hover table-striped" data-search="true" data-pagination="true" data-toggle="table" data-id-field="id" data-search-highlight="true" data-click-to-select="true" data-url="http://localhost/laksaohotel/api/admin/room_type/fetch" data-show-print="true" data-show-export="true" data-export-types=" ['csv', 'txt', 'doc', 'excel', 'pdf']">
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" />
    ...
    <h3 class="text-center">ລາຍງານຂໍ້ມູນປະເພດຫ້ອງພັກ</h3>
    <div class="desc">
