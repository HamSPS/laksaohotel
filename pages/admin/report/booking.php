...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        ...
        function showChart(year = '') {
            $.ajax({
                url: 'http://localhost/laksaohotel/api/admin/report/booking?chart',
                type: 'post',
                data: {
                    year: year,
                },
