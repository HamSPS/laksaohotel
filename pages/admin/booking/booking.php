...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="table" class="table data-table" data-classes="table table-hover table-striped" data-search="true" data-pagination="true" data-toggle="table" data-id-field="id" data-toolbar=".toolbar" data-search-highlight="true" data-click-to-select="true" data-url="http://localhost/laksaohotel/api/admin/booking/fetch">
                                        <thead>
    ...
    <script>
        ...
        function cancelBook(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/booking/cancel',
                        type: 'post',
                        data: {
                            'id': id,
                        },
        ...
        function viewBook(id) {
            $.ajax({
                url: 'http://localhost/laksaohotel/api/admin/booking/findOne',
                type: 'post',
                data: {
                    id: id,
                },
        ...
        function checkIn(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'http://localhost/laksaohotel/api/admin/booking/check-in',
                        type: 'post',
                        data: {
                            'id': id,
                        },
