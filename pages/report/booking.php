...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
            ...
            printPageBuilder: function(table) {
                ...
                return `
                        ...
                        <style type="text/css" media="all">
                            ...
                            <h3 class="text-center">ລາຍງານຂໍ້ມູນການຈອງ</h3>
                            <div class="desc">
        ...
        function showChart(year = '') {
            $.ajax({
                url: 'http://localhost/laksaohotel/api/report/booking?chart',
                type: 'post',
                data: {
                    year: year,
                },
                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < result.length; i++) {
                        ...
                        dataBook[i] = result[i].book;
                        dataCheckIn[i] = result[i].checkIn;
                        dataCancel[i] = result[i].cancel;
                    }
